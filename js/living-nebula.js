/**
 * Living Nebula — WebGL background shader (vanilla JS / Three.js via CDN)
 * Adapted from the React component for use in a static HTML site.
 */
(function () {
  ...
  // 5) Mouse interaction disabled — static nebula
